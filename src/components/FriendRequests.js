...
const FriendRequests = () => {
    ...
    const fetchFriendRequests = async () => {
        try {
            ...
            const res = await axios.get(`https://mern-friend-app-backend.onrender.com/api/friend/${userId}/friendRequests`, {
    ...
    const handleAccept = async (friendId) => {
        try {
            ...
            await axios.post(
                'https://mern-friend-app-backend.onrender.com/api/friend/accept',
                { userId, friendId },
                { headers: { 'x-auth-token': token } }
            );
    ...
    const handleDecline = async (friendId) => {
        try {
            ...
            await axios.post(
                'https://mern-friend-app-backend.onrender.com/api/friend/reject',
                { userId, friendId },
                { headers: { 'x-auth-token': token } }
            );
