...
const FriendRecommendations = () => {
    ...
    const fetchRecommendations = async () => {
        try {
            ...
            const res = await axios.get(`https://mern-friend-app-backend.onrender.com/api/friend/${userId}/recommendations`, {
    ...
    const handleAddFriend = async (friendId) => {
        try {
            ...
            const res = await axios.post(
                'https://mern-friend-app-backend.onrender.com/api/friend/request',
                { userId, friendId },
                { headers: { 'x-auth-token': token } }
            );
